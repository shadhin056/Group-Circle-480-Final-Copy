...
<div class="w3-sidebar w3-bar-block w3-card-2 w3-animate-right" style="display:none;right:0;" id="xxxx">
...
<script>
function w3_open() {
  document.getElementById("sidebar").style.marginRight = "25%";
  document.getElementById("xxxx").style.width = "25%";
